...
Lesson #1: Using R like a calculator
-----------------------------------
...
Lesson #2: The basic data structures in R
-----------------------------------
...
Lesson #3: Writing functions in R
-----------------------------------
...
Lesson #4: Writing loops and if/else
-----------------------------------
...
Lesson #5: (A short diversion) Bias in estimators
-----------------------------------

Now we will stop for a short digression about how to calculate the population variance and how to estimate the sample variance, since we can now use R to convince ourselves that the naive estimator for variance is biased. 
