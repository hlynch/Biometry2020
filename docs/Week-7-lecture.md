...
fox.data<-read.csv("Fox fur production.csv", header=F)
```
...
```
## [1]  0.0167771096  0.0182408194  0.0161383986 -0.0007622878 -0.0081314625
## [6] -0.0141724885  0.0085492327
```
...
## X range: ( -14.33896 , 15.02863 )
## Y range: ( -14.33896 , 15.02863 )
```
